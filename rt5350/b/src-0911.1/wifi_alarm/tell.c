...
int __tell_client(struct json_object *src, struct json_object *obj, char *command)
{
...
作用，通知所有紧急联系人
***************************************************/
int tell_friend(struct json_object *obj, char *command)
{
